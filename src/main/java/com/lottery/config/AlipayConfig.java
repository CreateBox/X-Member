...
//    public static String notify_url = "http://localhost:8080/alipay/notify_url.jsp";
    public static String notify_url = "http://192.168.0.104:8080/alipay/notify_url.jsp";

    // 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
//    public static String return_url = "http://localhost:8080/alipay/return_url.jsp";
    public static String return_url = "http://192.168.0.104:8080/alipay/return_url.jsp";
